...
def run_by_piont(sell=0,auto=0):
    ...
    while True:
        ...
        #开打
        start_button_pos = (1278,690,1438,732)
        if match_img(start_button_pos,"start_button_pos.png") < 1:
        ...
        if match_img(auto_fight,"auto_fight.png")< 1 or match_img(auto_fight,"auto_fight1.png")< 1:
